...
namespace SeatingChartApp.Migrations
{
    ...
    [Migration("20250921151740_InitialLineupMigration")]
    partial class InitialLineupMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SeatingChartApp.Models.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Category = "Dinner",
                            CookTimeMinutes = 30,
                            CreatedDate = new DateTime(2025, 9, 21, 11, 17, 40, 149, DateTimeKind.Local).AddTicks(8288),
                            IsFavorite = true,
                        ...
                        new
                        {
                            ...
                            Category = "Breakfast",
                            CookTimeMinutes = 15,
                            CreatedDate = new DateTime(2025, 9, 21, 11, 17, 40, 149, DateTimeKind.Local).AddTicks(9432),
                            IsFavorite = true,
                            Name = "Pancakes",
                            PrepTimeMinutes = 10,
                            Servings = 4
                        ...
                        new
                        {
                            ...
                            Category = "Lunch",
                            CookTimeMinutes = 10,
                            CreatedDate = new DateTime(2025, 9, 21, 11, 17, 40, 149, DateTimeKind.Local).AddTicks(9441),
                            IsFavorite = true,
                            Name = "Grilled Cheese",
                            PrepTimeMinutes = 5,
                            Servings = 2
